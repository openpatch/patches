function varCssColorMap(type) {
  const css = {};

  const keys = [50, 100, 200, 300, 400, 500, 600, 700, 800, 900];

  keys.forEach((key) => {
    css[key] = `var(--color-${type}-${key})`;
  });
...
var colors = {
  primary: varCssColorMap("primary"),
  neutrals: varCssColorMap("neutrals"),
  info: varCssColorMap("info"),
  warning: varCssColorMap("warning"),
  error: varCssColorMap("error"),
  success: varCssColorMap("success"),
};
